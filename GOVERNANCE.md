...
- Membership, scoring, and deliberation procedures are published in `docs/governance/review-board/README.md`. All artefacts are committed to the repo for public audit.
...
- **Decision Publication:** Outcomes, conditions, and dissent are summarised in a decision record and appended to `docs/governance/review-board/CHANGELOG.md`. Related PRs must link to the archived artefacts.
...
- **Transparency:** All major decisions and discussions will be documented and made available to the community, with Review Board artefacts stored in `docs/governance/review-board/`.
